...
func (m *EMail) buildReport() string {
	...
	s.WriteString("## Anonymized EMailAddresses : " + isArray(m.Local.RemovedEMails) + _linefeed)
	s.WriteString("## Anonymized PhoneNumbers   : " + isArray(m.Local.RemovedPhones) + _linefeed)
